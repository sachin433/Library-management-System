...
<div class="container" align="center">
            ...
            <h2>Request for a Book</h2><br>
<h5>Please fill the form below and we'll get the book you want! </h5>
<br>
<br>
 
<div class="form">
                <form action="successfulform.jsp" method="post">
                    <div class="row">
                        <div class="col-md-10">
 
                            <label style=" display: inline-block; width: 210px; text-align: right;">Book Name:</label>  <input id="bookname" style="padding:3px 3px 3px 3px;font-size: 15px; text-align: center;"  name="bookname" required>
...
<br/>
                        <div class="col-md-10">
                            <label style=" display: inline-block; width: 210px; text-align: right;"> Author : </label>  <input id="author" style="padding:3px 3px 3px 3px;font-size: 15px; text-align: center;" name="author" required>
                            <span class="required-star">*</span>
<br/>
</div>
<br/>
...
<br/>
                        <div class=" col-md-12">
                           <button class="btn white">Submit Request</button> 
