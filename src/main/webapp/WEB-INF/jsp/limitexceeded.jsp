...
&nbsp;
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Unable to Issue Book</span>
            
        </div>
    </div>
<div class="container" align="center">

<div class="alert alert-danger"><strong>Sorry!<br></strong>You have already reached the limit for issuing books.</div>
     </div> 
<footer>
