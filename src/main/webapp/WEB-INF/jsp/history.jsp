...
<head>
    ...
    <link rel="stylesheet" type="css/text/css" href="css/owl.carousel.min.css">
    ...
    <section class="static about-sec">
        <div class="container">
            ...
            <div class="recomended-sec">
               ...
               ArrayList<Transaction> transactions = (ArrayList<Transaction>)request.getAttribute("query");
    			for(Transaction t : transactions)
    			{
        			...
        			if(DOReturn==null)
        				...
        				style="";
        				linkOpened="<a href='returnconfirm.jsp?BookNo="+bookNo+"'&EmpId=123'>";
        				linkClosed="";
        				}
        			else{
